      ...
      <View style={styles.content}>
        {selectedService ? (
          <View style={styles.serviceDetailContainer}>
            ...
            <View style={styles.selectedServiceCard}>
              <View style={styles.serviceHeader}>
                ...
                <View style={styles.serviceInfo}>
                  ...
                  <ThemedText style={styles.statusText}>Trạng thái: {selectedService.status === 'completed' ? 'Đã thanh toán' : 'Đã hủy'}</ThemedText>
            ...
            {/* Payments List */}
            <FlatList
              data={mockPayments.filter(payment => payment.serviceId === selectedService.id)}
